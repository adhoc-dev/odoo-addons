...
class res_partner(models.Model):
    ...
    def check_vat_unique(self):
        ...
        if same_vat_partners:
            ...
            if same_vat_partners:
                raise Warning(_(
                    'Partner vat must be unique except on partner with parent/childe relationship. Partners with same vat and not related, are: %s!') % (', '.join(x.name for x in same_vat_partners)))
