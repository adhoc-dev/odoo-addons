    ...
    def product_id_change(
        ...
        if product:
            ...
            if (
                ...
                #     pricelist, product.id, qty=qty, uom=uom,
                #     qty_uos=qty_uos, uos=uos, name=name, partner_id=partner_id,
                #     lang=lang, update_tax=update_tax, date_order=date_order,
                #     packaging=packaging, fiscal_position=fiscal_position,
                #     flag=flag)
                # si tenemos instalado el modulo "sale_stock", entonces odoo por defecto
                # hace un hack y borrar la uom elegida y a uom y precio por defecto del producto
                # en nuestro caso entonces termina quedando mal porque cambiamos la uom pero no el precio
                # por eso forzamos el recalculo del precio
