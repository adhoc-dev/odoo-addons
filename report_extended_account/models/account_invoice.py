...
class account_invoice(models.Model):
    ...
    splitter_invoice_id = fields.Many2one(
        'account.invoice', 'Splitter Invoice',
    ...
    def invoice_print(self, cr, uid, ids, context=None):
        ...
        report_name = report_obj.get_report_name(
            cr, uid, 'account.invoice', ids, context=context)
    ...
    def copy(self, cr, uid, id, default=None, context=None):
        '''
        When an Invoice is copied the splitter and
        splitted invoices is not copy.
        '''
        if default is None:
            default = {}
                ...
                if len(inv.invoice_line) > lines_to_split:
                    ...
                    for sale_order_id in sale_order_ids:
                        ...
                        sale_order_obj.write(
                            cr, uid, [sale_order_id], vals, context=context)
    ...
    def action_date_assign(self, cr, uid, ids, *args):
        ...
        report = report_obj.get_report(
            cr, uid, 'account.invoice', ids, {'ignore_state': True})
