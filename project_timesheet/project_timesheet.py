...
# Modificacion por error al agregar lineas en una tarea cuando existen lineas de trabajo de partes valdiados
            ...
            for task_obj in self.browse(cr, uid, ids, context=context):
                if len(task_obj.work_ids):
                    for task_work in task_obj.work_ids:
                        ...
                        # Modificación por error al agregar lineas de trabajo en una tarea desde la vista form de proyectos
                        # hr_anlytic_timesheet.write(cr, uid, [line_id], vals_line, {})
                        hr_anlytic_timesheet.write(cr, 1, [line_id], vals_line, {})
