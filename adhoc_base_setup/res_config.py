...
class adhoc_base_configuration(osv.osv_memory):
    ...
    _columns = {
        ...
        'module_sale_add_products_wizard': fields.boolean('Add a wizard to add multiple products on a sale order',
...
then on sale orders lines this description will be used and no code"""),
        ...
        'module_project_tags': fields.boolean('Add Tags on Projects',
